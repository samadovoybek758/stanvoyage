...
const AllHero = ({
  ...
  return (
    <div className="h-[400px] md:h-[500px] lg:h-[640px] w-full relative before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-[#00000066] before:z-10 mb-20 md:mb-28 lg:mb-[120px]">
